...
def get_horoscope(sign):
    url = f'https://horoscopes.rambler.ru/{sign}/?updated' #rambler
    page = requests.get(url)
    soup = BeautifulSoup(page.content, 'html.parser')
    result = soup.find('div', class_='_1E4Zo _3BLIa') #rambler
    data = soup.find('span', class_='_2B_ig _2X8qK')#rambler data
